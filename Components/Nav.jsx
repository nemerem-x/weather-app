    ...
    <>
      ...
      <div className="nav">
        <div className="navbar">
          <img src={theme ? Logo_light : Logo} alt="logo" />

          <div className='relative flex items-center h-10 w-80'>
            <input
              className='absolute w-full rounded-3xl py-3 px-4 text-sm border-white border-2'
              ref={inputField}
              autoComplete='off'
